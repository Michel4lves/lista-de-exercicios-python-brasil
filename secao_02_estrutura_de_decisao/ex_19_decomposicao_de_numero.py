...
def decompor_numero(numero: int):
    ...
    if partes_numericas == 0:
        print('Número 0 não possui centena, dezena ou unidade')
    elif partes_numericas == 1:
        print(f"'{numero_print} = {centenas_str}{dezenas_str}{unidades_str}'")
    elif partes_numericas == 3:
        print(f"'{numero_print} = {centenas_str}, {dezenas_str} e {unidades_str}'")
    elif partes_numericas == 2:
        if centenas_str != '':
            segunda_parte = dezenas_str + unidades_str
            print(f"'{numero_print} = {centenas_str} e {segunda_parte}'")
        else:
            print(f"'{numero_print} = {dezenas_str} e {unidades_str}'")
